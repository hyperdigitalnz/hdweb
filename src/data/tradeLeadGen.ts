...
export const tradeLeadGen: Record<string, TradeLP> = {
  plumbers: {
    ...
    heroSub:
      "We build you a complete lead-to-job system: ads that reach ready-to-buy locals, a website that replies straight away, and follow-up that turns enquiries into jobs. Real calls and quote requests, not vanity clicks.",
